  ...
  return (
    <div className="text-[#00214d] mt-[7em]">
        <div className="flex flex-col justify-center items-center">
            ...
            <a href="mailto:abhinav210702@gmail.com"><p className="md:text-2xl md:mt-[2em] font-syne text-[#020826] mt-[1em] underline cursor-pointer text-lg mb-[1em] ">abhinav210702@gmail.com</p></a>
        </div>
    </div>
  )
}
