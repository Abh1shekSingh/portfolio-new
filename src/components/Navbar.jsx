...
const Navbar = () => {
  ...
  return (
    <motion.nav initial={{y:-250}} animate={{y:0}} transition={{duration:2, ease:'easeInOut'}} className="bg-transparent backdrop-blur-sm transition-all text-textlight duration-700 dark:text-textdark fixed top-0 z-20 w-full bg-bglight flex py-3 px-5 md:px-[9em] justify-between items-center ">
        <a href="/">
