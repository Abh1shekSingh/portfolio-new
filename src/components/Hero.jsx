...
const Hero = () => {
  ...
  return (
    <div className="w-full  h-screen flex justify-center items-center">
      <h1 className="w-full z-10 space-y-16 uppercase text-accent-300 text-[13vw] 2xl:text-[10vw] flex flex-col justify-between items-center font-montserrat font-bold ">
